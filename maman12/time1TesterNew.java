public class Time1Tester {
    public static void main(String[] args) {
        ...
        Time1 t134 = new Time1(7, 5);
        System.out.println("\tt134=" + t134);

        // if not in range
        Time1 t33 = new Time1(-17, 61);
        ...
        t33 = new Time1(23, 45);
        Time1 t34 = new Time1(23, 46);
        Time1 t35 = new Time1(22, 45);
        Time1 t36 = new Time1(23, 44);
        ...
        System.out.println("\tAdding -48 hours to " + t4 + "= " + t4.addMinutes((-48) * 60));
        System.out.println("\tAdding -49 hours to " + t4 + "= " + t4.addMinutes((-49) * 60));
        t4 = new Time1(0, 05);
